...
import { Typography, Container, Box, Card, CardHeader, CardContent } from '@mui/material';
  ...
  return (
    <Card variant="outlined">
      ...
      <CardContent sx={{ height: '200px', overflowY: 'auto' }}>
        <Box>
          <Typography variant="subtitle2" color="textSecondary" align="left" sx={{fontSize:"12px",color:"#565656"}}>
